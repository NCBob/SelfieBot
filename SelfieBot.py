...
exitButton = Button(27)
shutdownButton = Button(22)
...
sleepingSnoring = pygame.mixer.Sound('Sounds/sleep/sleepingSnore.wav')
...
def printSelfie(printFlag):
    ...
    if(printFlag != False):
        ...
        imageToPrint = imageToPrint.transpose(Image.FLIP_LEFT_RIGHT)
